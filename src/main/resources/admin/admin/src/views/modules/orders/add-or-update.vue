    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总价格" prop="total">
          <el-input v-model="ruleForm.total" 
              placeholder="总价格" clearable  :readonly="ro.total"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总价格" prop="total">
              <el-input v-model="ruleForm.total" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="团购编号" prop="groupno">
          <el-input v-model="ruleForm.groupno" 
              placeholder="团购编号" clearable  :readonly="ro.groupno"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="团购编号" prop="groupno">
              <el-input v-model="ruleForm.groupno" 
                placeholder="团购编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springbootf63od/upload');
        } else {
