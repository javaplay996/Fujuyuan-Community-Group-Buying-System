  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangjiashijian" label="上架时间" prop="shangjiashijian">
              <el-input v-model="ruleForm.shangjiashijian" 
                placeholder="上架时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="团购价" prop="groupprice">
          <el-input v-model="ruleForm.groupprice" 
              placeholder="团购价" clearable  :readonly="ro.groupprice"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="团购价" prop="groupprice">
              <el-input v-model="ruleForm.groupprice" 
                placeholder="团购价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拼团人数" prop="grouppeople">
          <el-input v-model="ruleForm.grouppeople" 
              placeholder="拼团人数" clearable  :readonly="ro.grouppeople"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拼团人数" prop="grouppeople">
              <el-input v-model="ruleForm.grouppeople" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="当前人数" prop="curpeople">
          <el-input v-model="ruleForm.curpeople" 
              placeholder="当前人数" clearable  :readonly="ro.curpeople"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="当前人数" prop="curpeople">
              <el-input v-model="ruleForm.curpeople" 
                placeholder="当前人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springbootf63od/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
